/*
  ...
  Puts a Blaeck device on the network: an Olimex ESP32-PoE passes bytes between one
  ...
  This sketch doesn't use the Blaeck library. The device behind it runs Blaeck,
...
void setup()
{
  ...
  // The UART the Blaeck device is wired to.
