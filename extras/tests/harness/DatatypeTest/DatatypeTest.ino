/*
  ...
  A debugging aid, not an application. Registers every datatype blaeck
...
void setup()
{
  ...
  device.addSignal(F("Bool_false"), &boolTest[0]);
  device.addSignal(F("Bool_true"), &boolTest[1]);
  device.addSignal(F("Byte_min"), &byteTest[0]);
  device.addSignal(F("Byte_max"), &byteTest[1]);
  device.addSignal(F("Short_min"), &shortTest[0]);
  device.addSignal(F("Short_max"), &shortTest[1]);
  device.addSignal(F("UShort_min"), &ushortTest[0]);
  device.addSignal(F("UShort_max"), &ushortTest[1]);
  device.addSignal(F("Int_min"), &intTest[0]);
  device.addSignal(F("Int_max"), &intTest[1]);
  device.addSignal(F("UInt_min"), &uintTest[0]);
  device.addSignal(F("UInt_max"), &uintTest[1]);
  device.addSignal(F("Long_min"), &longTest[0]);
  ...
  device.addSignal(F("Float_Inf"), &floatInfinity);
  device.addSignal(F("Float_NegInf"), &floatNegativeInfinity);
  device.addSignal(F("Double_min"), &doubleTest[0]);
  device.addSignal(F("Double_max"), &doubleTest[1]);
  device.addSignal(F("Double_NaN"), &doubleNaN);
  device.addSignal(F("Double_Inf"), &doubleInfinity);
  device.addSignal(F("Double_NegInf"), &doubleNegativeInfinity);
  device.addSignal(F("String_test"), stringTest);
}
