...
BlaeckCore::BlaeckCore(bool bufferedWrites)
    : DeviceHWVersion(_defaultBoardName()), _bufferedWrites(bufferedWrites)
{
...
void BlaeckCore::_setBufferedWritesDefault(bool enabled)
{
