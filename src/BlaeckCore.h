/*
    ...
    commands, state and event channels, and the frames that describe them. Both
    connection modes share this implementation and its compile-time configuration.
*/
...
protected:
  explicit BlaeckCore(bool bufferedWrites = BLAECK_SERIAL_BUFFERED_WRITES_DEFAULT);
...
// Source compatibility for sketches that explicitly named a transport's core namespace.
